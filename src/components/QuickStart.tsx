...
const QuickStart = () => {
  const features = [
    {
      number: 1,
      title: "Откройте Вордич в Telegram",
      description: "Найдите бота по поиску @kartapolaka_bot или воспользуйтесь прямой ссылкой на нашем сайте"
    },
    {
      number: 2,
    ...
    {
      number: 3,
      title: "Начни использовать бесплатно",
